...
//uncomment this out
    ...
    public void LoadGame(int slotNumber)  
{
    var loadedData = LoadingTypeSwitch(slotNumber);
    SetPlayerData(loadedData.playerData);
    SetEnvironmentData(loadedData.environmentData);
    SetDayNumber(loadedData.dayNumber); // Ensure this is called
    isLoading = false;
...
//     private void SetDayNumber(int dayNumber)
// {
//     // Update the TimeManager's dayInGame value
//     TimeManager.Instance.dayInGame = dayNumber;

//     // Update the UI to reflect the loaded day
